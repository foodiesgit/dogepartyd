...
UNSPENDABLE_MAINNET = 'MPTpSGZ7REYJMAFJ1J1mN8Wq8eem7an7u4'

ADDRESSVERSION_TESTNET = b'q'
# PRIVATEKEY_VERSION_TESTNET =
ADDRESSVERSION_MAINNET = b'\x32'
# PRIVATEKEY_VERSION_MAINNET =
MAGIC_BYTES_TESTNET = b'\xaf\x45\x76\xee'   # For bip-0010
MAGIC_BYTES_MAINNET = b'\xaf\x45\x76\xee'   # For bip-0010

WIF_PREFIX_TESTNET = b'\xb2'
WIF_PREFIX_MAINNET = b'\xb2'
...
BLOCK_FIRST_MAINNET_TESTCOIN = 535176
...
MAX_BURN_BY_ADDRESS = 500000 * UNIT     # 5M DOGE.
BURN_MULTIPLIER = 1                                     # from 1.5 to 1 XDP per 1000 DOGE.
...
DEFAULT_FEE_PER_KB = UNIT / 1000             # 1 DOGE.
